            ...
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                {performances.map((perf, idx) => {
                  ...
                  const imageUrl = perf.thumbnail_url 



                    ? (perf.thumbnail_url.startsWith('http') ? perf.thumbnail_url : (perf.thumbnail_url.startsWith('/') ? perf.thumbnail_url : `/${perf.thumbnail_url}`))
                ...
                return (
                  ...
                  >
                    ...
                    <div className="absolute bottom-0 left-0 p-8 w-full translate-y-2 group-hover:translate-y-0 transition-transform duration-500">
                      ...
                      <p className="text-accent text-[10px] font-black uppercase tracking-widest mb-3 italic opacity-90">{perf.category || '시공사례'}</p>

                      <h5 className="text-white font-black text-xl leading-tight mb-4 drop-shadow-md line-clamp-2">
                      ...
                      <Link 
                        ...
                        className="inline-flex items-center text-white/60 text-[11px] font-black uppercase tracking-widest hover:text-white transition-colors"
